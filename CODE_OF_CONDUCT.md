...
Criticising a design decision is not a conduct issue, and this project actively
invites it — there is a Discussions category for exactly that. Orrery makes strong
claims about what it enforces, and those claims are more valuable when people try
hard to break them.

The line is between the work and the person. "This guarantee does not hold, and
here is the case that breaks it" is the most useful thing you can bring. "Whoever
wrote this is incompetent" is not, and it makes the first kind of contribution
harder for everyone else to make.
...
to the maintainers through a
[private security advisory](https://github.com/DivyamTalwar/ORRERY/security/advisories/new),
which is the private reporting channel available on this repository. All complaints
